        ...
        <div className='flex justify-center items-center py-20'>
            <div className="w-11/12 mx-auto md:w-full max-w-md p-8 space-y-3 rounded-xl bg-blue-600 text-white">
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={handleGoogleSignIn} title="Log in with Google" className="p-3 hover:bg-blue-100 hover:text-black rounded-full">
                        <FaGoogle className='text-3xl' />
                    </button>

                    <button onClick={handleGitHubSignIn} title="Log in with GitHub" className="p-3  hover:bg-blue-100 hover:text-black rounded-full">
