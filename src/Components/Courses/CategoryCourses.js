            ...
            <div className="w-full max-w-sm  rounded-lg shadow-md bg-blue-700 border-0 h-[28rem]">
                ...
                <div className="px-5 pb-5 flex justify-between flex-col h-52">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <Link className="text-white bg-blue-900 hover:bg-blue-400 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-5 py-2.5 text-center ">Details</Link>
                    </div>
                </div>
            </div>
